...
<table class="table, table table-bordered table-light">
    <tr>
	<td><input type="number" class="form-control" name="a" placeholder="Enter ID " /></td>
</tr>
<tr>
...
<tr>
	<td><input type="email" class="form-control" name="t6" placeholder="Email" /></td>
</tr>
<tr>
	<td><input type="text" class="form-control" name="t7" placeholder="Department" /></td>
</tr>
<tr>
	<td><input type="text" class="form-control" name="b" placeholder="Position" /></td>
</tr>
<tr>
	<td><input type="text" class="form-control" name="c" placeholder="Place" /></td>
</tr>
<tr>
